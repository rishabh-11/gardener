...
func (b *Botanist) DeployClusterAutoscaler(ctx context.Context) error {
	if b.Shoot.WantsClusterAutoscaler {
		...
		md := b.Shoot.Components.Extensions.Worker.MachineDeployments()
		//fmt.Printf("cluster autoscaler b.Shoot.Components.Extensions.Worker.MD:- %v\n", md)
		b.Shoot.Components.ControlPlane.ClusterAutoscaler.SetMachineDeployments(md)
